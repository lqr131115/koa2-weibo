...
const squareViewRouter = require('./routes/view/blog-square')
const profileApiRouter = require('./routes/api/blog-profile')
const profileViewRouter = require('./routes/view/blog-profile')
...
app.use(squareViewRouter.routes(), squareViewRouter.allowedMethods())
app.use(profileApiRouter.routes(), profileApiRouter.allowedMethods())
app.use(profileViewRouter.routes(), profileViewRouter.allowedMethods())
